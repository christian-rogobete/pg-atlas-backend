...
class Settings(BaseSettings):
    ...
    #: Repos a funded project delivers into but does not own (comma-separated
    #: owner/repo). Repo-level signals there describe the hosting
    #: organization, not the funded work: declared host repos are never
    #: scheduled for collection, their profiles render every signal
    #: not-applicable, and they join no percentile pool.
