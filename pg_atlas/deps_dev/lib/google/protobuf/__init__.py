...
class DescriptorProto(betterproto2.Message):
    ...
    extension_range: "list[DescriptorProtoExtensionRange]" = betterproto2.field(5, betterproto2.TYPE_MESSAGE, repeated=True)
    ...
    reserved_range: "list[DescriptorProtoReservedRange]" = betterproto2.field(9, betterproto2.TYPE_MESSAGE, repeated=True)
...
class EnumDescriptorProto(betterproto2.Message):
    ...
    visibility: "SymbolVisibility" = betterproto2.field(6, betterproto2.TYPE_ENUM, default_factory=lambda: SymbolVisibility(0))
    """
    Support for `export` and `local` keywords on enums.
    """
...
class EnumOptions(betterproto2.Message):
    ...
    uninterpreted_option: "list[UninterpretedOption]" = betterproto2.field(999, betterproto2.TYPE_MESSAGE, repeated=True)
    """
...
class EnumValueOptions(betterproto2.Message):
    ...
    feature_support: "FieldOptionsFeatureSupport | None" = betterproto2.field(4, betterproto2.TYPE_MESSAGE, optional=True)
    """
...
class ExtensionRangeOptions(betterproto2.Message):
    ...
    declaration: "list[ExtensionRangeOptionsDeclaration]" = betterproto2.field(2, betterproto2.TYPE_MESSAGE, repeated=True)
    """
...
class FieldOptions(betterproto2.Message):
    ctype: "FieldOptionsCType" = betterproto2.field(1, betterproto2.TYPE_ENUM, default_factory=lambda: FieldOptionsCType(0))
    """
    ...
    jstype: "FieldOptionsJsType" = betterproto2.field(6, betterproto2.TYPE_ENUM, default_factory=lambda: FieldOptionsJsType(0))
    """
    ...
    edition_defaults: "list[FieldOptionsEditionDefault]" = betterproto2.field(20, betterproto2.TYPE_MESSAGE, repeated=True)
    ...
    feature_support: "FieldOptionsFeatureSupport | None" = betterproto2.field(22, betterproto2.TYPE_MESSAGE, optional=True)
