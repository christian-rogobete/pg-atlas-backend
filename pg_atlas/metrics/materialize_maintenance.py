...
def _build_repo_profile(
    ...
    *,
    ...
    # The canonical id carries the pkg:github/ prefix; the declared list is
    # keyed by bare owner/repo like the other per-repo overrides.
    declared = parse_declared_maintainers(settings.MAINTENANCE_DECLARED_MAINTAINERS).get(
        canonical_id.lower().removeprefix("pkg:github/"), frozenset()
    )
