...
def _cadence_signal_dict(
    ...
    *,
    ...
    block: dict[str, Any] = {"source": cadence.source, "shipping_events": cadence.shipping_events}
    rankable: dict[str, float] = {}
...
def _build_repo_profile(
    ...
    *,
    ...
    cadence_block, cadence_rankable = _cadence_signal_dict(
        canonical_id, releases, collected.release_fallback if collected is not None else None, now=now
    )
