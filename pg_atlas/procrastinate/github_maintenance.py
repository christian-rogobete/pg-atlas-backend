...
def maintenance_host_repo(owner: str, repo: str) -> bool:
    ...
    Some funded projects deliver their work into repositories owned by a
    third party (hardware-wallet support into vendor repos, for example).
    Declared host repos are never scheduled for collection, and the
    materializer renders their profiles with every signal not-applicable.
    """
